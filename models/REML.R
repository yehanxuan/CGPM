...
oneReplicate_REML = function(seedJ){
    ...
    eigenValues = as.vector(result$eigenvalues)
    return(list( "loss" = loss, "M_opt" = M_opt, "rank" = r_opt, "converge" = converge, "Time" = runTime,
                 "sysTime" = sysTime, "eigenValues" = eigenValues))
}
